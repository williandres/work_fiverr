...
enum : int {
    ...
    SBK_QTEXTCODEC_CONVERSIONFLAG_IDX                        = 280,
    SBK_QFLAGS_QTEXTCODEC_CONVERSIONFLAG_IDX                 = 115,
    SBK_QTEXTCODEC_IDX                                       = 279,
    SBK_QTEXTCODEC_CONVERTERSTATE_IDX                        = 281,
    SBK_QTEXTDECODER_IDX                                     = 282,
    SBK_QTEXTENCODER_IDX                                     = 283,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 287,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 285,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 288,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 286,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 116,
    SBK_QTEXTSTREAM_IDX                                      = 284,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 289,
    SBK_QTHREAD_PRIORITY_IDX                                 = 291,
    SBK_QTHREAD_IDX                                          = 290,
    SBK_QTHREADPOOL_IDX                                      = 292,
    SBK_QTIME_IDX                                            = 293,
    SBK_QTIMELINE_STATE_IDX                                  = 297,
    SBK_QTIMELINE_DIRECTION_IDX                              = 296,
    SBK_QTIMELINE_CURVESHAPE_IDX                             = 295,
    SBK_QTIMELINE_IDX                                        = 294,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 301,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 299,
    SBK_QTIMEZONE_IDX                                        = 298,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 300,
    SBK_QTIMER_IDX                                           = 302,
    SBK_QTIMEREVENT_IDX                                      = 303,
    SBK_QTRANSLATOR_IDX                                      = 304,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 305,
    SBK_QURL_PARSINGMODE_IDX                                 = 308,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 309,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 307,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 117,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 310,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 119,
    SBK_QURL_IDX                                             = 306,
    SBK_QURLQUERY_IDX                                        = 311,
    SBK_QUUID_VARIANT_IDX                                    = 314,
    SBK_QUUID_VERSION_IDX                                    = 315,
    SBK_QUUID_STRINGFORMAT_IDX                               = 313,
    SBK_QUUID_IDX                                            = 312,
    SBK_QVARIANTANIMATION_IDX                                = 316,
    SBK_QVERSIONNUMBER_IDX                                   = 317,
    SBK_QWAITCONDITION_IDX                                   = 318,
